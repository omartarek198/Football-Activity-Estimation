...
for i in range(0, len(videosPaths)):
    ...
    for directory in directories:
        for idx, filename in enumerate(videosPaths):
            ...
            templates.append(CreateTemplateFromVideo(path, directory,[15+10,10+10,4+10,6+10]))

    recognizer = Recognizer(templates)

    print("testing for shoot")

    result = recognizer.recognize(GetLandMarksFromVideo(testPath, [15+10,10+10,4+10,6+10]))
    print(result)
